...
function button1() {    //leetcode
  if(model.gameState===1){
    if(model.energy-150>=0 && model.happiness-25>=0 && model.hoursLeft-3>=0){
      model.hoursLeft -= 3;
      model.coding +=(Math.floor(Math.random() * 9)+2);
      model.energy -=150;
      model.happiness -=25;
      checkVariables();
...
function button2() {
  if(model.gameState===1){
    if(model.energy-50>=0 && model.happiness-20>=0 && model.hoursLeft-3>=0){
      model.hoursLeft -= 3;
      model.connections +=(Math.floor(Math.random() * 4)+4);
      model.personality +=(Math.floor(Math.random() * 5)+2);
      model.energy -=50;
      model.happiness -=20;
      checkVariables();
      //Update game logic here
...
function button4() {    //project
  if(model.gameState===1){
    if(model.energy-200>=0 && model.happiness-50>=0 && model.hoursLeft-12>=0){
      model.hoursLeft -= 12;
      model.coding +=(Math.floor(Math.random() * 6)+3);
      model.resume +=(Math.floor(Math.random() * 12)+7);
      model.happiness -=50;
      model.energy -=200;
      checkVariables();
      //Update game logic here
...
function button5() {    //friend
  if(model.gameState === 1){
    if(model.energy-25>=0 && model.hoursLeft-3>=0){
      model.hoursLeft -= 3;
      model.happiness +=500;
      model.personality +=(Math.floor(Math.random() * 10)+2);
      model.energy -=25;
      checkVariables();
      //Update game logic here
    } else if (model.hoursLeft-3<0){
